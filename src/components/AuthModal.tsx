...
export function AuthModal({ isOpen, onClose }: any) {
  ...
  return (
    <div className="fixed inset-0 bg-black/95 backdrop-blur-md flex items-center justify-center z-[100] animate-fadeIn" onClick={(e) => e.target === e.currentTarget && onClose()}>
