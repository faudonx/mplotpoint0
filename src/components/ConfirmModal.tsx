...
export function ConfirmModal({ isOpen, title, message, type, onConfirm, onCancel }: any) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-[12000] animate-fadeIn" onClick={(e) => e.target === e.currentTarget && onCancel()}>
